...
local function OpenBank()
    QBCore.Functions.TriggerCallback('qb-banking:server:openBank', function(accounts, statements, playerData, invoices)
        ...
        SendNUIMessage({
            ...
            language = playerData.metadata and playerData.metadata.bankLanguage or nil,
            theme = playerData.metadata and playerData.metadata.bankTheme or 'light'
        })
    end)
end
...
RegisterNUICallback('saveSettings', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-banking:server:saveSettings', function(status)
        cb(status)
    end, data)
end)

RegisterNUICallback('saveLanguage', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-banking:server:saveLanguage', function(status)
        cb(status)
    end, data)
end)
...
RegisterNUICallback('payInvoice', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-banking:server:payInvoice', function(status)
        cb(status)
    end, data)
end)
